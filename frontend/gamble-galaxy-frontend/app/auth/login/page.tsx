    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-2 sm:p-4">
      <Card className="w-full max-w-xs sm:max-w-sm md:max-w-md bg-gray-800 border-gray-700">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl sm:text-2xl font-bold text-white">Welcome Back</CardTitle>
          <p className="text-sm sm:text-base text-gray-300">Sign in to your Gamble Galaxy account</p>
        </CardHeader>
        <CardContent className="p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <div>
              <label htmlFor="username" className="block text-sm sm:text-base font-medium text-gray-200 mb-2">
                Username
              </label>
              <Input
                id="username"
            ...
            <div>
              <label htmlFor="password" className="block text-sm sm:text-base font-medium text-gray-200 mb-2">
                Password
              </label>
              <div className="relative">
                <Input
