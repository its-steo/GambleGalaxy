...
import { Plane, Trophy, Zap, Clock, CheckCircle, AlertCircle, Sparkles } from 'lucide-react';
import { Card, CardContent } from "@/components/ui/card";

export default function MaintenancePage() {
  const aviatorFeatures = [
    {
      icon: Sparkles,
      title: "AI-Powered Predictions",
      description: "Advanced machine learning algorithms for smarter betting suggestions",
    },
    {
      icon: Zap,
      title: "Ultra-Fast Multipliers",
      description: "Instant calculation with 10x faster processing speeds",
    },
    {
      icon: CheckCircle,
  ...
  const sportsBettingFeatures = [
    {
      icon: Trophy,
      title: "Live AI Analytics",
      description: "Real-time match analysis powered by artificial intelligence",
    },
    {
      icon: Zap,
      title: "Dynamic Odds Engine",
      description: "Auto-adjusting odds with predictive algorithms",
    },
    {
      icon: CheckCircle,
      title: "Instant Settlements",
      description: "Automated payouts verified by blockchain technology",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden relative">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-600/20 rounded-full blur-3xl opacity-50" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-blue-600/20 rounded-full blur-3xl opacity-50" />
        <div className="absolute top-1/2 right-0 w-80 h-80 bg-pink-600/20 rounded-full blur-3xl opacity-50" />
      </div>

      <div className="relative z-10">
        {/* Header */}
        <header className="border-b border-gray-800/50 backdrop-blur-md">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">
              We are enhancing Gamble Galaxy with powerful <span className="text-purple-400 font-semibold">AI automation</span> and cutting-edge features. We will be back online soon with an even better experience.
            </p>

            {/* Status Box */}
            <div className="bg-gradient-to-r from-purple-900/40 to-pink-900/40 backdrop-blur-md border border-purple-500/30 rounded-2xl p-8 max-w-2xl mx-auto mb-12">
              <div className="flex items-center justify-center gap-3 mb-4">
                <Clock className="w-6 h-6 text-blue-400 animate-spin" />
                <p className="text-lg text-gray-200">
                  Estimated completion: <span className="text-blue-400 font-semibold">Coming Soon</span>
                </p>
              </div>
              <p className="text-gray-300">
                Our engineering team is working around the clock to deliver enhanced features and improved performance.
              </p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-3xl font-bold text-white">Aviator Enhancements</h3>
              </div>

              <div className="space-y-4">
                {aviatorFeatures.map((feature, index) => (
                  <Card
                    key={index}
                    className="bg-white/5 backdrop-blur-md border border-purple-500/30 hover:border-purple-500/60 transition-all duration-300 hover:bg-white/10"
                  >
                    <CardContent className="p-6">
            ...
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-3xl font-bold text-white">Sports Betting Upgrades</h3>
              </div>

              <div className="space-y-4">
                {sportsBettingFeatures.map((feature, index) => (
                  <Card
                    key={index}
                    className="bg-white/5 backdrop-blur-md border border-green-500/30 hover:border-green-500/60 transition-all duration-300 hover:bg-white/10"
                  >
                    <CardContent className="p-6">
                      <div className="flex gap-4">
                        <div className="flex-shrink-0">
          ...
          <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 backdrop-blur-md border border-blue-500/30 rounded-2xl p-8 sm:p-12 mb-12">
            <div className="flex items-start gap-4 mb-6">
              <Sparkles className="w-8 h-8 text-blue-400 flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4">AI Automation Features</h3>
                <ul className="space-y-3">
                  <li className="flex gap-3 text-gray-200">
                    <CheckCircle className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                    <span>Intelligent betting pattern recognition and recommendations</span>
                  </li>
                  <li className="flex gap-3 text-gray-200">
                    <CheckCircle className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex gap-3 text-gray-200">
                    <CheckCircle className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                    <span>Real-time market analysis with predictive algorithms</span>
                  </li>
                  <li className="flex gap-3 text-gray-200">
                    <CheckCircle className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                    <span>Smart notifications for optimal betting opportunities</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6 text-center">
            <p className="text-gray-300 mb-4">
              We appreciate your patience as we build the next generation of sports betting and gaming platform.
            </p>
            <p className="text-sm text-gray-400">
              Questions? Contact us at support@gamblegalaxy.com
            </p>
          </div>
        </main>

        {/* Footer */}
        <footer className="border-t border-gray-800/50 backdrop-blur-md mt-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center text-gray-400 text-sm">
              <p>© 2025 Gamble Galaxy. All rights reserved. | Powered by Advanced AI Technology</p>
            </div>
          </div>
        </footer>
      </div>
