...
export function LiveCashouts({
  ...
  return (
    <Card className="bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-3xl border border-white/10 shadow-2xl rounded-2xl lg:rounded-3xl overflow-hidden relative">
      <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 via-transparent to-blue-500/5 rounded-2xl lg:rounded-3xl"></div>
              ...
              liveActivity.map((activity) => (
                ...
                >
                  ...
                  <div className="text-right relative z-10 min-w-0">
                    ...
                    <div className="text-xs text-white/50">{activity.type === "cashed_out" ? "won" : "potential"}</div>
                  </div>
                </div>
              ))
            )}
